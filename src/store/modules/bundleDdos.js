...
const getters = {
  ...
  [types.BUNDLE_DDOS]: state => {
    return state.data
  },
  [types.BUNDLE_TOTAL_DDOS]: state => {
    return state.size
  },
  [types.BUNDLE_DDOS_LOADING]: state => {
    return state.isLoading
  },
  [types.BUNDLE_DDOS_SELECTED_BUNDLE]: state => {
    return state.selectedBundle
  },
  [types.BUNDLE_DDOS_SELECTED_NODE]: state => {
    return state.selectedNode
  },
  [types.BUNDLE_DDOS_LEGEND]: state => {
    return state.legend
  }
}

const mutations = {
  [types.MUTATE_ALL_BUNDLE_DDOS]: (state, data) => {
  ...
  [types.MUTATE_BUNDLE_DDOS]: (state, data) => {
    state.data = data.data
  },
  [types.MUTATE_BUNDLE_DDOS_LOADING]: (state, data) => {
    state.isLoading = data
  },
  [types.MUTATE_BUNDLE_DDOS_SELECTED_BUNDLE]: (state, data) => {
    if (data == null) {
  ...
  [types.MUTATE_BUNDLE_DDOS_SELECTED_NODE]: (state, data) => {
    if (data == null) {
...
const actions = {
  [types.GET_ALL_BUNDLE_DDOS]: ({
    commit
  }, data) => {
    commit(types.MUTATE_BUNDLE_DDOS_LOADING, true)
    ...
    axios.post('/bundles-ddos', params, {
      ...
      .then(res => {
        if (res.data.data != null) {
          commit(types.MUTATE_BUNDLE_DDOS_LOADING, false)
          commit(types.MUTATE_ALL_BUNDLE_DDOS, res.data)
          commit(types.MUTATE_BUNDLE_DDOS_SELECTED_BUNDLE, null)
          commit(types.MUTATE_BUNDLE_DDOS_SELECTED_NODE, null)
        }
      })
      .catch(err => {
        commit(types.MUTATE_BUNDLE_DDOS_LOADING, false)
  ...
  [types.GET_BUNDLE]: ({
    ...
    axios.get('/bundles-ddos/' + id, {
      ...
      .then(res => {
        if (res.data != null) {
          commit(types.MUTATE_BUNDLE_DDOS, res.data)
          commit(types.MUTATE_BUNDLE_DDOS_LOADING, false)
        }
      })
      .catch(err => console.log(err))
  },
  [types.CHANGE_BUNDLE_DDOS_SELECTED_BUNDLE]: ({
    commit
  }, data) => {
    if (data == null) {
      commit(types.MUTATE_BUNDLE_DDOS_SELECTED_BUNDLE, null)
    } else {
      commit(types.MUTATE_BUNDLE_DDOS_SELECTED_BUNDLE, data)
    }
  },
  [types.CHANGE_BUNDLE_DDOS_SELECTED_NODE]: ({
    commit
  }, data) => {
    if (data == null) {
      commit(types.MUTATE_BUNDLE_DDOS_SELECTED_NODE, null)
    } else {
      commit(types.MUTATE_BUNDLE_DDOS_SELECTED_NODE, data)
    }
  }
}
