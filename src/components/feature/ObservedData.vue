  ...
  export default {
    ...
    data() {
      return {
        ...
        options: [
          { text: 'ID', value: 'id'},
          { text: 'Number Observed', value: 'number_observed'},
          { text: 'Source IP', value: 'objects.0.value'},
          { text: 'Destination IP', value: 'objects.1.value'},
          { text: 'Destination Port', value: 'objects.2.value'},
        ],
        search: '',
        pagination: {
          "descending": false,
      ...
      pagination: {
        handler() {
          if (this.selectedOption != "" && this.search != "") {
            this.params = {...this.pagination, searchBy: this.selectedOption, query: this.search}
          } else {
            this.params = {...this.pagination, searchBy: '', query: ''}
          }
        }
      },
      search: {
